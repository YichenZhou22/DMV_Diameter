...
%       voxSize    - the voxel size of the GRE image (unit in m)
%       TE         - the echo time (unit in s)
%       mag_vein   - the mean magnitude value of a relatively larger vein (this can be obtained by labelling the larger vein) 
%   output:
